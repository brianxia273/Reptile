...
p2BatchSize: int = 512  # {16, 512, 1028}
p2Epochs: int = 200  # {20, 200, 1000}
...
p3NN: str = "FCNN"
p3NNSize = p3Size = 40
p3NNEpoch: int = 200  # {20, 200, 1000}
p3NNBatch: int = 512  # {16, 512, 1028}
...
p4BatchSize: int = 512  # {16, 512, 1028} (?)

# Choosing Meta-Trained NN using its parameters
p4NN: str = "FCNN"
p4NNSize: int = 40
p4NNEpoch: int = 200  # {20, 200, 1000}
p4NNBatch: int = 512  # {16, 512, 1028}
